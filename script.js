...
/* ============ TESTIMONIALS ============ */
const testimonials = [
  { name: 'Talha Khan', role: 'Head of CX, NovaTech',          text: 'ClawBot reduced our support backlog by 72% in the first two weeks. Our team can now focus on complex cases while ClawBot handles everything routine — perfectly.',          stars: 5, bg: 'linear-gradient(135deg,#00f5ff,#00b4cc)', initials: 'SM' },
  { name: 'Bilal Ahmed',  role: 'Founder, Shopwave Africa',       text: 'We deployed ClawBot on WhatsApp for our Nigerian e-commerce customers. Response times dropped from 6 hours to under a second. The revenue impact was immediate.',           stars: 5, bg: 'linear-gradient(135deg,#bf00ff,#7b00cc)', initials: 'JO' },
  { name: 'Ahtisham Rajput',    role: 'VP Engineering, FinEdge',        text: 'The API integration was cleaner than anything we\'ve worked with. SOC 2 certification gave our compliance team confidence. ClawBot is production-ready out of the box.',       stars: 5, bg: 'linear-gradient(135deg,#ff0090,#cc0073)', initials: 'PM' },
  { name: 'Talha Bajwa',  role: 'CEO, Scandinavian Retail Group', text: 'We\'re live in Swedish, Norwegian, Danish, and Finnish simultaneously. ClawBot handles all four with zero quality drop. Language support is genuinely impressive.',         stars: 5, bg: 'linear-gradient(135deg,#00ff88,#00cc6a)', initials: 'DL' },
  { name: 'Ahad Gujjar',   role: 'Growth Director, LeadPulse',     text: 'A/B testing conversation flows inside ClawBot\'s dashboard helped us improve lead capture rate by 38%. The analytics are deep and actionable.',                             stars: 5, bg: 'linear-gradient(135deg,#ffaa00,#ff8c00)', initials: 'AD' },
];
